...
(async () => {
  ...
  // const zero = await Course.find();

  // const a = stu.map(x=>x)
  // console.log(a)
  
  // const lastversion  = async(stus) =>{
  //    // const recupid= stu.map(element=>element.courses.map(id=>(Course.findById(id)))
  //     return Student
  //     // return {
  //     //     totaux: 0,
  //     //     label:y ,
  ...
  //     // }
  // }
  // console.log(await lastversion(stu))
